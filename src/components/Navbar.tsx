  ...
  return (
    <nav className={`navbar navbar-expand-lg navbar-${navBackgroundColor()} bg-${navBackgroundColor}`}>
      <div className="container-fluid">
        <a className="navbar-brand" style={{ color: textColor() }} href="/">{navProps.title}</a>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              <a className="nav-link active" style={{ color: textColor() }} aria-current="page" href="/">Home</a>
            </li>
            <li className="nav-item">
              <a className="nav-link active" style={{ color: textColor() }} href="/about">About</a>
            </li>
            <li className="nav-item">
              <a className="nav-link active" style={{ color: textColor() }} href="/contact">Contact</a>
            </li>
          </ul>

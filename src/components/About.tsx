            ...
            <div className="accordion" id="accordionExample">
                ...
                <div className="accordion-item">
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                            This utility provides a feature called The Age Utility, which can ascertain the age or duration between two dates. The resulting age will be presented in years, months, and days.
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
                    <h2 className="accordion-header" id="headingThree">
                        <button className="accordion-button collapsed" style={myStyle} type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                            <strong>Difference Checker </strong>
                        </button>
                    </h2>
                    <div id="collapseThree" className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                        <div className="accordion-body" style={myStyle}>
                        Moreover, this tool distinguishes between two paragraphs. Identifying disparities can prove challenging, particularly with lengthy passages.
                        </div>
                    </div>
                </div>
                <div className="accordion-item">
